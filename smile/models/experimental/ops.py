...
def sn_conv(x, d, k, s, use_bias=True, padding="SAME", n_power_iterations=1, reuse=None):

    # TODO: Add assertion about data format. NHWC is expected.

    # TODO: Need scope as input as well? What happens when this is called under a variable scope with reuse?

    var_scope_name = "sn_conv"
    if not reuse:
        var_scope_name = _unique_layer_name(var_scope_name)
        # TODO:
        pass
