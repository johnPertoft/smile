...
# TODO: Use hparam for architecture. Remove the celeb sub package.
...
cyclegan = CycleGAN(
    ...
    a_test=input_fn(args.x_test, 5),
    a_test_static=first_n(args.x_text, 10),
    b_train=input_fn(args.y_train, hparams["batch_size"]),
    b_test=input_fn(args.y_test, 5),
    b_test_static=first_n(args.y_test, 10),
    generator_fn=architectures.GENERATORS[hparams["generator-architecture"]],
    discriminator_fn=architectures.DISCRIMINATORS[hparams["discriminator-architecture"]],
    **hparams)
